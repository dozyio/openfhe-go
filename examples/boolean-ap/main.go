...
func main() {
	fmt.Println("Starting BinFHE boolean example with AP bootstrapping")
	...
	err = cc.GenerateBinFHEContext(openfhe.STD128, openfhe.AP)
	...
	fmt.Println("\nBoolean AP bootstrapping example completed successfully!")
}
