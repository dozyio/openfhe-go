...
PKEErr CryptoContext_EvalMinSchemeSwitching(
    CryptoContextPtr cc, CiphertextPtr ciphertext, void *publicKey,
    uint32_t numValues, uint32_t numSlots, uint32_t pLWE, double scaleSign,
    CiphertextPtr *outValue, CiphertextPtr *outIndex);
